...
replace (
	github.com/Prabhjot-Sethi/cluster-api-provider-bringyourownhost => ./
...
require (
	...
	github.com/Prabhjot-Sethi/cluster-api-provider-bringyourownhost v0.0.0-00010101000000-000000000000
	k8s.io/api v0.23.0
