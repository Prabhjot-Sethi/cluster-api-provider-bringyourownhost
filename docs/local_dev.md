...
- [BYOH](https://github.com/Prabhjot-Sethi/cluster-api-provider-bringyourownhost) provider to add the above hosts to the aforemention workload cluster
...
In order to do so you need to clone both https://github.com/kubernetes-sigs/cluster-api/ and https://github.com/Prabhjot-Sethi/cluster-api-provider-bringyourownhost locally;
