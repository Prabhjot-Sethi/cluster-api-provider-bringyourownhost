...
import (
	...
	"github.com/Prabhjot-Sethi/cluster-api-provider-bringyourownhost/agent/version"
	infrastructurev1beta1 "github.com/Prabhjot-Sethi/cluster-api-provider-bringyourownhost/apis/infrastructure/v1beta1"
	"github.com/Prabhjot-Sethi/cluster-api-provider-bringyourownhost/test/builder"
...
var _ = Describe("Agent", func() {
	...
	Context("When host agent is executed with --version flag", func() {
		...
		BeforeEach(func() {
			...
			ldflags := fmt.Sprintf("-X 'github.com/Prabhjot-Sethi/cluster-api-provider-bringyourownhost/agent/version.GitMajor=%s'"+
				"-X 'github.com/Prabhjot-Sethi/cluster-api-provider-bringyourownhost/agent/version.GitMinor=%s'"+
				"-X 'github.com/Prabhjot-Sethi/cluster-api-provider-bringyourownhost/agent/version.GitVersion=%s'"+
				"-X 'github.com/Prabhjot-Sethi/cluster-api-provider-bringyourownhost/agent/version.GitCommit=%s'"+
				"-X 'github.com/Prabhjot-Sethi/cluster-api-provider-bringyourownhost/agent/version.GitTreeState=%s'"+
				"-X 'github.com/Prabhjot-Sethi/cluster-api-provider-bringyourownhost/agent/version.BuildDate=%s'",
				version.GitMajor, version.GitMinor, version.GitVersion, version.GitCommit, version.GitTreeState, version.BuildDate)

			tmpHostAgentBinary, err = gexec.Build("github.com/Prabhjot-Sethi/cluster-api-provider-bringyourownhost/agent", "-ldflags", ldflags)
			Expect(err).NotTo(HaveOccurred())
		})
	...
	Context("When --version flag is created using 'version.sh' script", func() {
		...
		BeforeEach(func() {
			...
			tmpHostAgentBinary, err = gexec.Build("github.com/Prabhjot-Sethi/cluster-api-provider-bringyourownhost/agent", "-ldflags", string(ldflags))
			Expect(err).NotTo(HaveOccurred())
		})
